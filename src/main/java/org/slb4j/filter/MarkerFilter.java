...
/**
 * The MarkerFilter class is an implementation of the LogFilter interface
 * that filters log entries based on their marker.
 */
public final class MarkerFilter implements LogFilter {
    ...
    /**
     * Constructs a new MarkerFilter with the specified name and predicate.
     *
     * @param name  the name of the filter
     * @param markerFilter the predicate to test the marker against
     */
